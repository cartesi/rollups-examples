...
m2cgen is a customized DApp written in Python, which originally resembles the one provided by the sample [Echo DApp](https://github.com/cartesi/rollups-examples/tree/main/echo).

The documentation below is simply a copy of the one provided there and should be used to both run the original m2cgen code and as a basis for the documentation of any DApp created based on this m2cgen.
...
```shell
$ npx hardhat --network localhost m2cgen:addInput --input "0x63617274657369"
```
...
```shell
$ npx hardhat --network localhost m2cgen:getNotices --epoch 0
```
...
```shell
$ npx hardhat --network localhost m2cgen:addInput --input 'Hello there!'
```
...
```shell
[2022-01-21 15:58:39,555] INFO in m2cgen: Received advance request body {'metadata': {'msg_sender': '0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266', 'epoch_index': 0, 'input_index': 0, 'block_number': 11, 'time_stamp': 1642791522}, 'payload': '0x636172746573690d0a'}
[2022-01-21 15:58:39,556] INFO in m2cgen: Adding notice
[2022-01-21 15:58:39,650] INFO in m2cgen: Received notice status 201 body b'{"index":0}'
[2022-01-21 15:58:39,651] INFO in m2cgen: Finishing
[2022-01-21 15:58:39,666] INFO in m2cgen: Received finish status 202
```
