...
cp ./lerImagem $DAPP_FS
(cd $DAPP_FS; tar --sort=name --mtime="2022-01-01" --owner=0 --group=0 --numeric-owner -cf $DAPP_FS_TAR img-proc.py lerImagem)
genext2fs -f -i 2048 -b 64 -a $DAPP_FS_TAR $DAPP_FS_BIN
